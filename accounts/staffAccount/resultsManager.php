    ...
    <main>
        <div class="dashboard-container">
            ...
            <div class="dashboard-cards">
                <div class="dashboard-card" onclick="location.href='upload_marks.php'">
                    <i class="fas fa-upload"></i> <!-- changed from users to upload -->
                    <h3>Upload Marks</h3>
                </div>

                <div class="dashboard-card" onclick="location.href='view_marks.php'">
                    <i class="fas fa-edit"></i> <!-- changed from chart-line to edit -->
