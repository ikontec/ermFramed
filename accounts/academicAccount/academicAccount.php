...
<body>
    ...
    <nav class="nav">
        ...
        <ul>
            ...
            <li><a href="../headOffice_Account/head.html"><i class="fas fa-chalkboard-teacher"></i> Administration Account</a></li>
    ...
    <main>
        <div class="dashboard-container">
            ...
            <div class="dashboard-cards">
                ...
                <div class="dashboard-card" onclick="location.href='staff.html'">
                    <i class="fas fa-users"></i>
